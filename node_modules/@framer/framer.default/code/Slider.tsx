...
export function Slider({
    ...
    useEffect(() => {
        if (RenderTarget.current() === RenderTarget.canvas) setWidth(frameWidth)
    }, [frameWidth])
    ...
    React.useLayoutEffect(() => {
        const handleResize = () => {
            ...
            x.set(transform(currentValue, [min, max], [0, updatedWidth]))
        }
        window.addEventListener("resize", handleResize)
        handleResize()
        return () => window.removeEventListener("resize", handleResize)
    }, [containerRef.current, value, min, max, currentValue])
