    ...
    return (
        <motion.div
            style={{
                ...
                alignItems: "center",
                padding: `0 ${inset + trackOffset}px`,
                borderRadius: fusedTrackRadius,
                overflow: "hidden",
            }}
            animate={{
                backgroundColor: isToggled
                    ? colorTokentoValue(trackColorOn)
                    : colorTokentoValue(trackColorOff),
                border: isToggled
                    ? colorTokentoValue(borderOn)
                    : colorTokentoValue(borderOff),
            }}
            initial={false}
        ...
        >
            <motion.div
                initial={false}
                style={{ width: "100%" }}
                animate={{ x: isToggled ? `calc(100% - ${knobSize}px)` : "0%" }}
                ...
                <motion.div
                    ...
                    animate={{
                        background: isToggled
                            ? colorTokentoValue(knobColorOn)
                            : colorTokentoValue(knobColorOff),
                    }}
                    style={{
                        pointerEvents: "none",
